...
export const HeaderComponent = () => {
    ...
    return <div className="2xl:container.BAK 2xl:mx-auto.BAK">
        <div className="bg-white rounded shadow-lg py-5 px-7">
            <nav className="flex justify-between">
                <div className="flex items-center space-x-3 lg:pr-16 pr-6">
                    ...
                    <h2 className="font-normal text-2xl leading-6 text-gray-800">Crypto Mob</h2>
                </div>

                <ul className="hidden md:flex flex-auto space-x-2">
                    <li  className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white bg-indigo-600 cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">Collections</li>
